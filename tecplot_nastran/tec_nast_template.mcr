#!MC 1410
$!ReadDataSet  '"StandardSyntax" "1.0" "FEALoaderVersion" "443" "FILENAME_File" "${op2_file}" "SubdivideZonesBy" "Component" "AutoAssignStrandIDs" "Yes" "ZoneList" "${order_num},3" "VarNameList" "Displacement" "InitialPlotType" "Cartesian3D" "ShowFirstZoneOnly" "No"'
...
$!ExportSetup ExportFName = '${save_path}/mode_order_${order_num}.png'
$!Export 
